...
import { AlignCenterIcon, AlignJustifyIcon, AlignLeftIcon, AlignRightIcon, Bold, ChevronDownIcon, HighlighterIcon, ImageIcon, Italic, Link2Icon, ListCollapseIcon, ListIcon, ListOrderedIcon, ListTodoIcon, LucideIcon, MessageSquarePlusIcon, MinusIcon, PlusIcon, Printer, Redo2Icon, RemoveFormattingIcon, SearchIcon, SpellCheck, Underline, Undo2Icon, Upload } from "lucide-react";
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button
                    className={cn(
                        "h-7 min-w-7 shrink-0 flex items-center flex-col justify-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"
                    )}
                >
...
const FontSizeButton = () => {
    ...
    return (
        <div className="flex items-center gap-0.5"> 
            <button onClick={decreaseFontSize}  className="h-7 w-7 shrink-0 flex items-center justify-center rounded-sm hover:bg-neutral-200/80">
            ...
            <button onClick={increaseFontSize}  className="h-7 w-7 shrink-0 flex items-center justify-center rounded-sm hover:bg-neutral-200/80">
